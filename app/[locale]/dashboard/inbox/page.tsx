...
export default function InboxPage() {
  ...
  return (
    <div className="h-[calc(100vh-10rem)] lg:h-[calc(100vh-8.5rem)] flex gap-3 overflow-hidden -mx-4 lg:-mx-6 xl:-mx-4">
      ...
      {selectedConv && (
        <div className="w-[240px] lg:w-[240px] xl:w-[260px] hidden lg:flex flex-col gap-6 overflow-y-auto pb-10">
