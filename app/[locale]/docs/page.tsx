...
const DOCS_DATA: Record<string, any> = {
  tr: {
    badge: "J.Caesar Açık Bilgi Merkezi",
    title: "Geliştirici Portalına",
    subtitle: "Hoş Geldiniz",
    desc: "J.Caesar platformunun yapay zeka entegrasyon kurallarını, gelişmiş RAG altyapısını, Özel API & Webhook bağlamalarını ve otonom CRM takvim sistemlerini keşfedin.",
    tabs: {
      overview: "Genel Bakış",
      rag: "RAG & Akıllı Arama",
      webhooks: "Webhook & API",
      channels: "CRM & E-Ticaret",
      smtp: "SMTP & E-Posta"
    },
    sections: {
      overview: {
      ...
      smtp: {
        ...
        limits_d: "Kullanıcılar paketlerinin %80 ve %100 limitlerine yaklaştıklarında, sistem arayüz üzerinden gerçek zamanlı uyarının yanında, kayıtli e-posta adreslerine şık bir HTML yükseltme maili atar."
      }
    }
  },
  en: {
    badge: "J.Caesar Open Knowledge Hub",
    title: "Welcome to",
    subtitle: "Developer Portal",
    desc: "Explore J.Caesar integration policies, advanced RAG parameters, custom API bindings, and omnichannel CRM automations.",
    tabs: {
      overview: "Overview",
      rag: "RAG & Search",
      webhooks: "Webhook & API",
      channels: "CRM & E-Commerce",
      smtp: "SMTP & E-Mail"
    },
    sections: {
      overview: {
...
export default function PublicDocsPage() {
  ...
  const lang = DOCS_DATA[currentLocale] || DOCS_DATA["tr"];

  return (
    <div className="min-h-screen bg-zinc-50 flex flex-col font-sans antialiased text-zinc-900 selection:bg-indigo-500 selection:text-white">
      
      {/* Navigation Menu */}
      <Navigation />

      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-32 space-y-12">
        ...
        <div className="relative rounded-[40px] bg-gradient-to-r from-zinc-900 to-black p-12 overflow-hidden shadow-2xl border border-zinc-800">
          ...
          <div className="relative z-10 space-y-4 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-xs font-black uppercase tracking-widest animate-pulse">
